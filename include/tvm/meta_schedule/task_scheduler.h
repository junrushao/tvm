...
class TaskSchedulerNode : public runtime::Object {
 public:
   ...
   */
  virtual void Tune(Array<TuneContext> tasks, Array<FloatImm> task_weights, int max_trials_global,
...
class PyTaskSchedulerNode : public TaskSchedulerNode {
 public:
  ...
  using FTune = runtime::TypedPackedFunc<void(
      Array<TuneContext> tasks, Array<FloatImm> task_weights, int max_trials_global,

...
python3 -m pylint -j${PYLINT_THREADS} tests/python/unittest/test_crt.py --rcfile="$(dirname "$0")"/pylintrc
python3 -m pylint -j${PYLINT_THREADS} tests/python/unittest/test_tvmscript_type.py --rcfile="$(dirname "$0")"/pylintrc

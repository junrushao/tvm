...
if __name__ == "__main__":
    test_postproc_verify_gpu_0()
    test_postproc_verify_gpu_1()
    test_postproc_verify_gpu_2()
    test_postproc_verify_gpu_3()
    test_postproc_verify_gpu_4()
    test_postproc_verify_gpu_5()
    test_postproc_verify_gpu_6()

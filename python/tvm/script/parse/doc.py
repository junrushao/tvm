...
class AugAssign(stmt):
    ...
    def __init__(
        self, target, op, value, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.target = target
        self.op = op
...
class For(stmt):
    ...
    def __init__(
        self, target, iter, body, orelse, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.target = target
        self.iter = iter
...
class While(stmt):
    ...
    def __init__(
        self, test, body, orelse, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.test = test
        self.body = body
...
class ImportFrom(stmt):
    ...
    def __init__(
        self, module, names, level, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.module = module
        self.names = names
...
class DictComp(expr):
    ...
    def __init__(
        self, key, value, generators, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.key = key
        self.value = value
...
class Compare(expr):
    ...
    def __init__(
        self, left, ops, comparators, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.left = left
        self.ops = ops
...
class Call(expr):
    ...
    def __init__(
        self, func, args, keywords, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.func = func
        self.args = args
...
class Constant(expr):
    ...
    def __init__(
        self, value, kind, s, n, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.value = value
        self.kind = kind
...
class Attribute(expr):
    ...
    def __init__(
        self, value, attr, ctx, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.value = value
        self.attr = attr
...
class Slice(slice):
    ...
    def __init__(
        self, lower, upper, step, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.lower = lower
        self.upper = upper
...
class Subscript(expr):
    ...
    def __init__(
        self, value, slice, ctx, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.value = value
        self.slice = slice
...
class ExceptHandler(excepthandler):
    ...
    def __init__(
        self, type, name, body, lineno, col_offset, end_lineno, end_col_offset
    ):
        super().__init__(lineno, col_offset, end_lineno, end_col_offset)
        self.type = type
        self.name = name
